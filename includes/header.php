...
<head>
    ...
    <title>Corridor Group</title>
        ...
        <link rel="stylesheet" href="assets/cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  ...
  <script src="assets/cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.1/jquery.waypoints.min.js"></script>
  ...
  <style>
    ...
    /* Media query for smaller screens (up to 767 pixels) */
...
<header class="header about-bg d-none d-lg-block">
      ...
      <div class="col-12">
        <div class="mobile-header-elements">
          <div class="mobile-logo">
            <a href="index.php"><img src="assets/logo/logo-white.png" class="logo" alt=""></a>
          </div>
  ...
  <div class="mobile-sidebar">
   <div class="logoicons-area">
      <div class="logos">
        <img src="assets/logo/logo-white.png" class="logo2" alt="">
      </div>
        ...
        <div class="footer4-contact-info">
          <div class="contact-info-single">
            ...
            <div class="contact-info-text">
              <a href="mailto:contact@corridor-group.com" class="font-ks font-16 lineh-26 weight-500 color-21">contact@corridor-group.com</a>
            </div>
          </div>
          ...
          <div class="contact-info-single">
              ...
              <div class="contact-info-text">
                <a href="contact.php" class="font-ks font-16 lineh-26 weight-500 color-21">Contact</a>
              </div>
            </div>
